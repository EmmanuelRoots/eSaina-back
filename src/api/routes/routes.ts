...
export function RegisterRoutes(app: Router) {
  ...
  app.post(
    ...
    async function UserController_logOut(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUserController_logOut,
          request,
          response,
        })
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsUserController_searChUser: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  ...
  app.get(
    '/user/get-users-by-name',
    ...fetchMiddlewares<RequestHandler>(UserController),
    ...fetchMiddlewares<RequestHandler>(
      UserController.prototype.getUsersByName
    ),

    async function UserController_getUsersByName(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUserController_getUsersByName,
          request,
          response,
        })
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsSSEController_sendNotification: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      SSEController.prototype.sendNotification
    ),

    async function SSEController_sendNotification(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSSEController_sendNotification,
          request,
          response,
        })
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsSalonController_getUserSalon: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  ...
  app.get(
    ...
    async function SalonController_getUserSalon(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSalonController_getUserSalon,
          request,
          response,
        })
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsPostController_getSalonPost: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    salonId: {
